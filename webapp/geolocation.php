...
<div id="left_menu">
    <div style="background-color: #fff;" class="width pt-1">
        <div class="ms-1 mt-1 pb-2" style="width: fit-content;">
            <font class="fs-4 fw-bold"><a href="http://username.000webhostapp.com/logout.php" class="btn fa fa-power-off text-white bg-danger ms-1 me-1 logout_btn" style="    border-radius:25px;padding: 5px 6px;"></a>Live Vehical Tracking</font><br>
        </div>
    </div>
